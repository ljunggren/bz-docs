...
The book idea is to complement the documentation already available on [boozang.com](https://boozang.com) with real life examples and practical tips on automating end to end scenarios in an enterprise context.
